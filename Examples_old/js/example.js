...
function initPhysics() {
	...
	// AssertFailedHandlerJS exists on newer embind builds; the Examples_old wasm-compat bundle may not expose it.
	if (typeof Jolt.AssertFailedHandlerJS === 'function') {
